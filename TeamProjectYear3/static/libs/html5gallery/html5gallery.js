 ...
 */
(function() {
    for (var p = document.getElementsByTagName("script"), s = "", m = 0; m < p.length; m++) p[m].src && p[m].src.match(/html5gallery\.js/i) && (s = p[m].src.substr(0, p[m].src.lastIndexOf("/") + 1));
    p = !1;
    if ("undefined" == typeof jQuery) p = !0;
    else if (m = jQuery.fn.jquery.split("."), 1 > m[0] || 1 == m[0] && 6 > m[1]) p = !0;
    if (p) {
...
function loadHtml5Gallery(p) {
        ...
        return this.each(function() {
            function a(a) {
                ...
                1 <= b.targetTouches.length ?
                    (h = b.targetTouches[0].pageX, n = b.targetTouches[0].pageY) : c(a)
            }

            function d(a) {
                e.preventWebBrowser && a.preventDefault();
                var b = a.originalEvent;
                1 <= b.targetTouches.length ? (g = b.targetTouches[0].pageX, y = b.targetTouches[0].pageY) : c(a)
            }

            function b(a) {
                if (0 < g || 0 < y) 100 < Math.abs(g - h) && (g > h ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()), 100 < Math.abs(y - n) && (y > n ? e.swipeBottom && e.swipeBottom.call() : e.swipeTop && e.swipeTop.call());
                c(a)
            }
    ...
    m.fn.drag = function(c, e, a) {
        var d = "string" == typeof c ? c : "",
            b = m.isFunction(c) ? c : m.isFunction(e) ? e : null;
        ...
        j = r.drag = {
            ...
            interaction: function(c, e) {
                return {
                    ...
                    droppable: [],
                    offset: m(c)[e.relative ? "position" : "offset"]() || {
                        top: 0,
                        left: 0
                    }
                }
            ...
            delegate: function(c) {
                ...
                m.each(d.live || [], function(b, d) {
                    if (0 === d.preType.indexOf("drag") && (a = m(c.target).closest(d.selector, c.currentTarget)[0])) q.add(a, d.origType + "." + j.livekey, d.origHandler, d.data), 0 > m.inArray(a, e) && e.push(a)
                });
            ...
            hijack: function(c, e, a, d, b) {
                if (a) {
                    var k = c.originalEvent,
                        h = c.type,
                        n = e.indexOf("drop") ? "drag" : "drop",
                        g, x = d || 0,
                        f, p;
                    d = !isNaN(d) ?
                    ...
                    a.results = [];
                    do
                        if ((f = a.interactions[x]) && !("dragend" !== e && f.cancelled)) p = j.properties(c, a, f), f.results = [], m(b || f[n] || a.droppable).each(function(b, d) {
                                g = (p.target = d) ? q.handle.call(d, c, p) : null;
                                !1 === g ? ("drag" == n && (f.cancelled = !0, a.propagates -= 1), "drop" == e && (f[n][b] = null)) : "dropinit" == e && f.droppable.push(j.element(g) || d);
                                "dragstart" == e && (f.proxy = m(j.element(g) || f.drag)[0]);
                                f.results.push(g);
                                delete c.result;
                                if ("dropinit" !== e) return g
                            }), a.results[x] =
                            j.flatten(f.results), "dropinit" == e && (f.droppable = j.flatten(f.droppable)), "dragstart" == e && !f.cancelled && p.update();
                    while (++x < d);
                    c.type = h;
                    c.originalEvent = k;
    ...
    z.fn.html5boxTransition = function(c, e, a, d, b) {
        ...
        var k = d.easing,
            ...
            n = d.direction,
            g = null;
        c && (c = c.split(","), g = c[Math.floor(Math.random() * c.length)], g = z.trim(g.toLowerCase()));
        g && d[g] && (d[g].duration && (h = d[g].duration), d[g].easing && (k = d[g].easing));
        "fade" == g ? (a.hide(), e.insertBefore(a), a.fadeIn(h, k, function() {
            e.remove();
            b()
        })) : "crossfade" == g || "fadeout" == g ? (a.hide(),
            e.fadeOut(h / 2, k, function() {
    ...
    var f = jQuery;
    f.fn.addHTML5VideoControls = function(c, e) {
        var a = "ontouchstart" in window,
            d = a ? "touchstart" : "mousedown",
            b = a ? "touchmove" : "mousemove",
            k = a ? "touchcancel" : "mouseup",
        ...
        var D = f("<div class='html5boxVideoPlay'></div>");
        p || (l.after(D), D.css({
            position: "absolute",
            top: "50%",
            left: "50%",
        ...
        setInterval(function() {
            m && (t.show(), m = !1, clearTimeout(g), g = setTimeout(function() {
                l.get(0).paused || t.fadeOut()
            }, 5E3))
        }, 250);
        f(".html5boxVideoControlsBg", t).css({
            display: "block",
            position: "absolute",
            width: "100%",
            height: "100%",
        ...
        f(".html5boxPlayPause", t).css({
            display: "block",
            position: "relative",
            width: "32px",
            height: "32px",
            margin: Math.floor((n - 32) / 2),
            "float": "left"
        });
        var H = f(".html5boxPlay", t),
            I = f(".html5boxPause", t);
        H.css({
            display: "block",
            position: "absolute",
        ...
        var C = f(".html5boxTimeCurrent", t),
            L = f(".html5boxTimeTotal",
                t),
            v = f(".html5boxSeeker", t),
            E = f(".html5boxSeekerPlay", t),
            M = f(".html5boxSeekerBuffer", t),
            O = f(".html5boxSeekerHandler", t);
        C.css({
            display: "block",
            position: "relative",
            "float": "left",
        ...
        v.css({
            ...
            margin: Math.floor((n - 10) / 2) + "px 4px"
        }).bind(d, function(c) {
        ...
        if (!p && (l.get(0).requestFullscreen || l.get(0).webkitRequestFullScreen || l.get(0).mozRequestFullScreen || l.get(0).webkitEnterFullScreen || l.get(0).msRequestFullscreen)) {
            var J = function(a) {
                t.css({
                ...
                a ? (f(document).bind("mousemove", z), t.css({
                    "z-index": 2147483647
                })) : (f(document).unbind("mousemove", z), t.css({
                    "z-index": ""
                }))
            };
            ...
            f("head").append("<style type='text/css'>video::-webkit-media-controls { display:none !important; }</style>");
            var A = f(".html5boxFullscreen", t);
            A.css({
                display: "block",
                position: "relative",
                "float": "right",
                ...
                var a = f(this).css("background-position") ? f(this).css("background-position").split(" ")[0] : f(this).css("background-position-x");
                f(this).css({
                ...
                (j = !j) ? (l.get(0).requestFullscreen ? l.get(0).requestFullscreen() : l.get(0).webkitRequestFullScreen ?
        ...
        s &&
            f(".html5boxHD", t).css({
                ...
                l.get(0).setAttribute("src", (q ? s : r) + "#t=" + l.get(0).currentTime);
                a ? p || l.get(0).pause() : l.get(0).play()
            });
        u = l.get(0).volume;
        l.get(0).volume =
            u / 2 + 0.1;
        if (l.get(0).volume === u / 2 + 0.1) {
            l.get(0).volume = u;
            var u = f(".html5boxVolume", t),
                F = f(".html5boxVolumeButton", t),
                K = f(".html5boxVolumeBar", t),
                w = f(".html5boxVolumeBarBg", t),
                B = f(".html5boxVolumeBarActive", t);
            u.css({
                display: "block",
                position: "relative",
                "float": "right",
            ...
            F.css({
                ...
                var b = f(this).css("background-position") ? f(this).css("background-position").split(" ")[1] : f(this).css("background-position-y");
                F.css({
            ...
            K.css({
                ...
                width: 24,
                height: 80,
                "margin-bottom": Math.floor((n - 32) / 2),
                "background-color": "#000000",
                opacity: 0.7,
                filter: "alpha(opacity=70)"
            });
        ...
        var N = function(a) {
            ...
            h = function() {
                if (l.get(0).buffered && 0 < l.get(0).buffered.length && !isNaN(l.get(0).buffered.end(0)) && !isNaN(l.get(0).duration)) {
                    var a = v.width();
                    M.css({
                        width: Math.round(a * l.get(0).buffered.end(0) / l.get(0).duration)
                    })
                }
            };
        try {
    ...
    c.fn.html5gallery = function(f) {
        ...
        e.prototype = {
            ...
            initData: function(a) {
                ...
                if (this.options.src && 0 < this.options.src.length) {
                    ...
                    if (c && c.feed && c.feed.entry)
                        for (var d = 0; d < c.feed.entry.length; d++) b.elemArray.push([d, ("https:" == document.location.protocol ? "https:" : "http:") + "//img.youtube.com/vi/" + c.feed.entry[d].media$group.yt$videoid.$t + "/0.jpg", c.feed.entry[d].media$group.media$player.url,
            ...
            readTags: function() {
                ...
                c("img", this.container).each(function() {
                    ...
                    var h = a.options.width,
                        n = a.options.height,
                        g = c(this).data("duration") ? c(this).data("duration") : 0,
                        f = null,
                        j = null,
                        m = null,
                        p = null,
                        ...
                        r = null,
                        l = null;
                    c(this).parent().is("a") && (d = c(this).parent().attr("href"), f = c(this).parent().data("ogg"), j = c(this).parent().data("webm"), m = c(this).parent().data("link"), p = c(this).parent().data("linktarget"), q = c(this).parent().data("poster"), isNaN(c(this).parent().data("width")) || (h = c(this).parent().data("width")), isNaN(c(this).parent().data("height")) ||
                        (n = c(this).parent().data("height")), s = c(this).parent().data("hd"), r = c(this).parent().data("hdogg"), l = c(this).parent().data("hdwebm"));
                    var u = c(this).parent().data("mediatype") ? c(this).parent().data("mediatype") : a.checkType(d);
                    a.elemArray.push([a.elemArray.length, c(this).attr("src"), d, f, j, m, p, b, e, u, h, n, q, s, r, l, g])
                })
            },
                ...
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (this.options.showcarousel)
                        if ("bottom" ==
                            ...
                            (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin, this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin, this.options.carouselTop = this.options.padding;
                    ...
                    if (1 == a || this.showingPoster) {
                    ...
                    } else if (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) a = this.elemArray[this.curElem][10], d = this.elemArray[this.curElem][11], this.isFullscreen ? (b = Math.min(this.fullscreenWidth / a, this.fullscreenHeight /
                        d), b = 1 < b ? 1 : b, a = Math.round(b * a), b = Math.round(b * d), this.adjustFullscreen(a, b, !0)) : (a = this.options.width, b = this.options.height), c(".html5gallery-elem-" + this.id).css({
                        width: a + "px",
                        height: b + "px"
                        ...
                        width: a + "px",
                        height: b + "px"
                    }), c("#html5gallery-elem-video-" + this.id).attr("width", a), c("#html5gallery-elem-video-" + this.id).attr("height", b), c(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", a), c(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", b), c("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", a), c("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", b);
                    d = a = 0;
                    ...
                    this.options.showcarousel && (c(".html5gallery-car-" +
                            this.id).css({
                            ...
                            width: this.options.carouselWidth + "px"
                        }), this.options.thumbShowNum = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)), this.options.thumbMaskHeight = this.options.thumbShowNum *
                        this.options.thumbheight + (this.options.thumbShowNum - 1) * this.options.thumbgap, this.options.thumbTotalHeight = this.elemArray.length * this.options.thumbheight + (this.elemArray.length - 1) * this.options.thumbgap, this.options.carouselSlider && (this.options.carouselSliderMin = 0, this.options.carouselSliderMax = this.options.thumbMaskHeight - 54, c(".html5gallery-car-slider-bar-" + this.id).css({
                            ...
                            display: "block"
                        })), a = 0, this.options.carouselNavButton && (a = Math.round(this.options.carAreaLength / 2 - this.options.thumbMaskHeight / 2)), c(".html5gallery-car-mask-" +
                            this.id).css({
                            top: a + "px",
                            height: this.options.thumbMaskHeight + "px"
            ...
            createStyleVertical: function() {
                ...
                this.options.showcarousel ? "bottom" == this.options.carouselposition ? (this.options.carouselWidth = this.options.width,
                    ...
                    this.options.thumbwidth, this.options.carouselHeight = this.options.height + this.options.headerHeight, this.options.carTop = 0, this.options.carBottom = 0, this.options.carAreaLength = this.options.carouselHeight - this.options.carTop - this.options.carBottom, this.options.carouselSlider = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) < this.elemArray.length, this.options.carouselSlider && (this.options.carouselWidth += 20), "left" == this.options.carouselposition ? (this.options.boxLeft =
                        this.options.padding + this.options.carouselWidth + this.options.carouselmargin, this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin, this.options.carouselTop = this.options.padding) : (this.options.carouselWidth = 0, this.options.carouselHeight = 0, this.options.carouselLeft = 0, this.options.carouselTop = 0, this.options.carouselmargin = 0);
                "bottom" == this.options.carouselposition ? (this.options.totalWidth = this.options.width + 2 * this.options.padding,
                    this.options.totalHeight = this.options.height + this.options.headerHeight + 2 * this.options.padding + this.options.carouselmargin + this.options.carouselHeight) : (this.options.totalWidth = this.options.width + this.options.carouselWidth + this.options.carouselmargin + 2 * this.options.padding, this.options.totalHeight = this.options.height + this.options.headerHeight + 2 * this.options.padding);
                this.options.containerWidth = this.options.totalWidth;
                this.options.containerHeight = this.options.totalHeight;
                this.options.responsive ? (this.options.originalWidth =
                    this.options.width, this.options.originalHeight = this.options.height, this.container.css({
                        "max-width": "100%"
                    })) : this.container.css({
                    width: this.options.containerWidth,
                    height: this.options.containerHeight
                ...
                "top" == this.options.headerpos ? (d = 0, a = this.options.socialheight, this.options.elemTop = this.options.headerHeight) : "bottom" == this.options.headerpos && (this.options.elemTop = 0, a = this.options.titleoverlay ? this.options.height - this.options.titleheight : this.options.height, d = this.options.titleoverlay ?
                ...
                var b = b + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft + "px; top:" + this.options.boxTop + "px; width:" + this.options.boxWidth + "px; height:" + this.options.boxHeight + "px; }"),
                    ...
                    b = b + (" .html5gallery-viral-" + this.id +
                    ...
                    b = this.options.titleoverlay ? "top" == this.options.headerpos ? b + "top:0px; height:auto; }" : b + "bottom:0px; height:auto; }" :
                    b + ("top:" + a + "px; height:" + this.options.titleheight + "px; }"),
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    this.options.showcarousel && (c(".html5gallery-car-" + this.id).css({
                        ...
                        }), this.options.carouselNavButton = !1, Math.floor((this.options.width - a - 4) / (this.options.thumbwidth + this.options.thumbgap)) < this.elemArray.length && (this.options.carouselNavButton = !0), d = this.options.carouselNavButton ? 72 : 0, c(".html5gallery-car-left-" + this.id).css({
                        ...
                        Math.floor((this.options.width - a - 4 - d) / (this.options.thumbwidth + this.options.thumbgap)), this.options.thumbMaskWidth = this.options.thumbShowNum * this.options.thumbwidth + this.options.thumbShowNum * this.options.thumbgap, this.options.thumbTotalWidth = this.elemArray.length * this.options.thumbwidth + (this.elemArray.length - 1) * this.options.thumbgap, d = 0, this.options.carouselmultirows ? (d = Math.floor(this.options.width / (this.options.thumbwidth + this.options.thumbgap)), 1 > d && (d = 1), d = (this.options.width - d * this.options.thumbwidth -
                            (d - 1) * this.options.thumbgap) / 2, c(".html5gallery-thumbs-" + this.id).css({
                            "margin-left": d + "px",
                            width: this.options.width + "px"
                        ...
                        })), a = Math.round((this.options.width - a - 4) / 2 - this.options.thumbMaskWidth / 2), c(".html5gallery-car-mask-" +
                            this.id).css({
                            left: a + "px",
            ...
            createStyleDefault: function() {
                ...
                this.options.showcarousel && this.options.carouselmultirows ? (b += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; width:" + this.options.width + "px;", b = this.options.carouselbgtransparent ? b + "background-color:transparent;" : b + ("border-top:1px solid " + this.options.carouseltopborder + ";border-bottom:1px solid " + this.options.carouselbottomborder + ";background-color: " + this.options.carouselbgcolorend + "; background: " +
                    ...
                    this.id + " { position:absolute; overflow:hidden; width:32px; height:32px; right:0px; top:" + String(this.options.carouselHeight / 2 - 16) + "px; background:url('" + this.options.skinfolder + "carousel_right.png') no-repeat 0px 0px;} ", d = this.options.carouselNavButton ? 72 : 0, c(".html5gallery-car-left-" + this.id).css({
                        display: this.options.carouselNavButton ? "block" : "none"
                    }), c(".html5gallery-car-right-" + this.id).css({
                        display: this.options.carouselNavButton ? "block" : "none"
                    ...
                    this.id + " { filter:alpha(opacity=" + Math.round(100 * this.options.thumbopacity) + "); opacity:" + this.options.thumbopacity + "; }  .html5gallery-tn-selected-" + this.id + " { filter:alpha(opacity=100); opacity:1; } ", b += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}", this.options.thumbunselectedimagebordercolor && (b += " .html5gallery-tn-selected-" +
                        ...
                        var a =
                            c(".html5gallery-thumbs-" + this.id, this.$gallery);
                ...
                for (var b = 0; b < this.elemArray.length; b++) {
                    ...
                    c(e).load(function() {
                        var b = Math.max(a.options.thumbimagewidth / this.width, a.options.thumbimageheight / this.height),
                            ...
                            g = a.options.thumbshowplayonvideo &&
                        ...
                        c("#html5gallery-tn-" + a.id + "-" + this.data, d).append("<div class='html5gallery-tn-img-" + a.id + "' style='position:relative;'><div style='display:block; overflow:hidden; position:absolute; width:" +
                            a.options.thumbimagewidth + "px;height:" + a.options.thumbimageheight + "px; top:" + a.options.thumbimageborder + "px; left:" + a.options.thumbimageborder + "px;'><img class='html5gallery-tn-image-" + a.id + "' style='border:none; padding:0px; margin:0px; max-width:100%; max-height:none; width:" + e + "px; height:" + b + "px;' src='" + a.elemArray[this.data][1] + "' /></div>" + g + "</div><div class='html5gallery-tn-title-" + a.id + "'>" + a.elemArray[this.data][7] + (a.options.thumbshowdescription ? "<br /><span class='html5gallery-tn-description-" +
                                a.id + "'>" + a.elemArray[this.data][8] + "</span>" : "") + "</div>");
                        a.options.thumblinkintitle && c(".html5gallery-tn-img-" + a.id, d).unbind("click").click(function() {
            ...
            goFullscreen: function() {
                ...
                clearTimeout(this.slideshowTimeout);
                c(".html5gallery-fullscreen-timer-" +
                ...
                var h = Math.max(e, c(document).height()),
                    n = Math.min(this.fullscreenWidth / d, this.fullscreenHeight / b);
                1 > n && (d *= n, b *= n);
                e = c(window).scrollTop() + Math.round((e - (b + 2 * this.fullscreenMargin + this.fullscreenBarH)) / 2);
                this.$fullscreen = c("<div class='html5gallery-fullscreen-" + this.id + "' style='position:absolute;top:0px;left:0px;width:" +
                ...
                var f = c(".html5gallery-elem-" + this.id, this.$gallery).empty().css({
                    top: 0,
                    position: "relative"
                });
                ...
                c(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).hover(function() {
                    1 < g.elemArray.length && (c(".html5gallery-fullscreen-next-" + g.id, g.$fullscreen).fadeIn(), c(".html5gallery-fullscreen-prev-" + g.id, g.$fullscreen).fadeIn())
                }, function() {
                    c(".html5gallery-fullscreen-next-" + g.id, g.$fullscreen).fadeOut();
                    c(".html5gallery-fullscreen-prev-" + g.id,
                ...
                c(".html5gallery-fullscreen-play-" + this.id, this.$fullscreen).click(function() {
                    c(".html5gallery-fullscreen-play-" + g.id, g.$fullscreen).hide();
                    c(".html5gallery-fullscreen-pause-" + g.id, g.$fullscreen).show();
                    g.isPaused = !1;
                    g.slideshowTimeout = setTimeout(function() {
                        g.slideRun(-1)
                    }, g.elemArray[g.curElem][16] ? g.elemArray[g.curElem][16] : g.options.slideshowinterval);
                    c(".html5gallery-fullscreen-timer-" + g.id, g.$fullscreen).css({
                        width: 0
                    });
                    g.slideTimerCount = 0;
                ...
                c(".html5gallery-fullscreen-pause-" + this.id, this.$fullscreen).click(function() {
                    c(".html5gallery-fullscreen-play-" + g.id, g.$fullscreen).show();
                    c(".html5gallery-fullscreen-pause-" + g.id, g.$fullscreen).hide();
                    g.isPaused = !0;
            ...
            slideRun: function(a, d, b, e) {
                ...
                if (this.options.showtitle ||
                    ...
                    if (this.isFullscreen) {
                        var n = "";
                        this.options.lightboxshowtitle && h && (n += h);
                        this.options.lightboxshowdescription && a && (n += "<div class='html5gallery-fullscreen-description-" + this.id + "'>" + a + "</div>");
                        c(".html5gallery-fullscreen-title-" +
                            this.id, this.$fullscreen).html(n)
                    } else this.options.showtitle && (h = "<div class='html5gallery-title-text-" + this.id + "'>" + h + "</div>", this.options.showdescription && a && (h += "<div class='html5gallery-description-text-" + this.id + "'>" + a + "</div>"), c(".html5gallery-title-" + this.id, this.$gallery).html(h))
                }
                a = this.elemArray[this.curElem][9];
                if (!(0 > a)) {
                    ...
                    this.onChange();
                    d = c(".html5gallery-elem-" + this.id, g);
                    ...
                    var g = this.isFullscreen ? this.$fullscreen : this.$gallery;
                    this.showingPoster = !1;
                    (5 == a ||
                        6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) && !b && this.elemArray[this.curElem][12] ? (this.showingPoster = !0, this.showPoster()) : (c(".html5gallery-video-play-" + this.id, g).length && c(".html5gallery-video-play-" + this.id, g).remove(), 1 == a ? this.showImage() : 5 == a || 6 == a || 7 == a || 8 == a ? this.showVideo(b, e) : 9 == a ? this.showYoutube(b) : 10 == a ? this.showVimeo(b) : 11 == a ? this.showEmbedVideo(b) : 2 == a && this.showSWF());
                    ...
                    if ((1 == a || this.showingPoster) &&
                        ...
                        f.slideRun(-1)
                    }, this.elemArray[this.curElem][16] ? this.elemArray[this.curElem][16] : this.options.slideshowinterval), this.isFullscreen ? c(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).css({
                        width: 0
                    }) : c(".html5gallery-timer-" + this.id, this.$gallery).css({
                        width: 0
            ...
            showImage: function() {
                ...
                c(b).load(function() {
                    ...
                    var f = d.isFullscreen ? e : d.options.width,
                        g = d.isFullscreen ? b : d.options.height,
                        j = Math.round(f / 2 - e / 2),
                        m = Math.round(g / 2 - b / 2);
                    d.isFullscreen && d.adjustFullscreen(f, g);
                    a.css({
                        width: f,
                        height: g
                    });
                    e = c("<div class='html5gallery-elem-img-" + d.id + "' style='display:block; position:absolute; overflow:hidden; width:" + f + "px; height:" + g + "px; left:0px; margin-left:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" +
                        (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + d.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + j + "px; top:" + m + "px; max-width:none; max-height:none; width:" + e + "px; height:" + b + "px;' src='" + d.elemArray[d.curElem][2] + "' />" + d.options.watermarkcode + "</div>");
            ...
            adjustFullscreen: function(a, d, b) {
                ...
                var f = Math.max(h, c(document).height()),
                    g = Math.min(this.fullscreenWidth / a, this.fullscreenHeight / d);
                1 > g && (a *= g, d *= g);
                ...
                b ?
                    (c(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).css({
            ...
            showPoster: function() {
                ...
                c(f).load(function() {
                    $preloading.remove();
                    var g, f, n;
                    b.isFullscreen ? (g = Math.max(e / this.width, h / this.height), g = 1 < g ? 1 : g,
                        f = e, n = h) : (g = "fill" == b.options.resizemode ? Math.max(b.options.width / this.width, b.options.height / this.height) : Math.min(b.options.width / this.width, b.options.height / this.height), f = b.options.width, n = b.options.height);
                    var j = Math.round(g * this.width);
                    g = Math.round(g * this.height);
                    var m = Math.round(f / 2 - j / 2),
                        p = Math.round(n / 2 - g / 2);
                    b.isFullscreen && b.adjustFullscreen(f, n);
                    d.css({
                        width: f,
                        height: n
                    });
                    f = c("<div class='html5gallery-elem-img-" + b.id + "' style='display:block; position:absolute; overflow:hidden; width:" + f +
                        "px; height:" + n + "px; left:0px; margin-left:" + (b.options.slideshadow && !b.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (b.options.slideshadow && !b.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + b.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + m + "px; top:" + p + "px; max-width:none; max-height:none; width:" + j + "px; height:" + g + "px;' src='" + b.elemArray[b.curElem][12] + "' />" + b.options.watermarkcode + "</div>");
                    n = c(".html5gallery-elem-img-" +
                        b.id, d);
                    n.length ? (d.prepend(f), d.html5boxTransition(b.id, n, f, {
            ...
            showVideo: function(a, d) {
                ...
                var b = this.isFullscreen ? this.$fullscreen : this.$gallery,
                    e = this.elemArray[this.curElem][10],
                    h = this.elemArray[this.curElem][11];
                this.isFullscreen ? this.adjustFullscreen(e, h) : (c(".html5gallery-elem-" + this.id, this.$gallery).css({
                ...
                if (this.isHTML5) {
                    ...
                    this.embedHTML5Video(c(".html5gallery-elem-video-" +
                        this.id, b), e, h, g, j, a, f, d)
                } else f = this.elemArray[this.curElem][2], "/" != f.charAt(0) && ("http:" != f.substring(0, 5) && "https:" != f.substring(0, 6)) && (f = this.options.htmlfolder + f), g = "", this.elemArray[this.curElem][13] && (g = this.elemArray[this.curElem][13], "/" != g.charAt(0) && ("http:" != g.substring(0, 5) && "https:" != g.substring(0, 6)) && (g = this.options.htmlfolder + g)), this.embedFlash(c(".html5gallery-elem-video-" + this.id, b), "100%", "100%", this.options.jsfolder + "html5boxplayer.swf", "transparent", {
                    width: e,
                    height: h,
            ...
            showSWF: function() {
                ...
                this.embedFlash(c(".html5gallery-elem-flash-" + this.id,
                    a), d, b, this.elemArray[this.curElem][2], "window", {});
            ...
            showEmbedVideo: function(a) {
                ...
                if (h.match(/\:\/\/.*(dai\.ly)/i)) var f =
                    h.match(/(dai\.ly\/)([a-zA-Z0-9\-\_]+)/)[2],
                    h = (h.match(/https\:\/\//i) ? "https" : "http") + "://www.dailymotion.com/embed/video/" + f;
            ...
            showYoutube: function(a) {
                ...
                if (ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7) {
                    ...
                    var g = this.getYoutubeParams(this.elemArray[this.curElem][2]),
                        g = c.extend({
                            html5: 1,
                            controls: f.options.videohidecontrols ? "0" : "1",
                            showinfo: f.options.videohidecontrols ? "0" : "1",
                            autoplay: a ? 1 : 0,
                            rel: 0,
                            wmode: "transparent"
                        }, g);
                ...
                } else h = this.prepareYoutubeHref(h),
                    a && (h = 0 > h.indexOf("?") ? h + "?autoplay=1" : h + "&autoplay=1"), h = 0 > h.indexOf("?") ? h + "?wmode=transparent&rel=0" : h + "&wmode=transparent&rel=0", f.options.videohidecontrols && (h += "&controls=0&showinfo=0"), c("#html5gallery-elem-video-" + this.id, d).html("<iframe width='" + b + "' height='" + e + "' src='" + h + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                this.options.googleanalyticsaccount && window._gaq.push(["_trackEvent", "Video", "Play", this.elemArray[this.curElem][7]])
            },
            showVimeo: function(a) {
                ...
                var f = this.elemArray[this.curElem][2],
                    f = 0 > f.indexOf("?") ?
                    f + "?" : f + "&",
                    f = a && !this.options.isAndroid ? f + "autoplay=1" : f + "autoplay=0",
                    f = f + ("&api=1&player_id=html5gallery_vimeo_" + this.id);
                ...
                c(".html5gallery-elem-video-" + this.id, b).html("<iframe id='html5gallery_vimeo_" + this.id + "' width='" + e + "' height='" + h + "' src='" + f + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                ...
                this.options.googleanalyticsaccount && window._gaq.push(["_trackEvent",
                    "Video", "Play", this.elemArray[this.curElem][7]
                ])
            },
            ...
            onThumbOver: function() {
                if (this.options.onthumbover && window[this.options.onthumbover] &&
                    "function" == typeof window[this.options.onthumbover]) window[this.options.onthumbover](this.elemArray[this.curElem])
            },
            onThumbClick: function(a) {
                if (this.options.onthumbclick && window[this.options.onthumbclick] && "function" == typeof window[this.options.onthumbclick]) window[this.options.onthumbclick](this.elemArray[a]);
                this.options.thumbjumptotop && (0 <= this.options.thumbjumpposition ? c(window).scrollTop(this.options.thumbjumpposition) : (a = this.container.offset().top, a < c(window).scrollTop() && c(window).scrollTop(a)))
            },
            onVideoEnd: function() {
            ...
            embedHTML5Video: function(a, d, b, e, f, j, g, m) {
                a.html("<div class='html5gallery-elem-video-container-" + this.id + "' style='position:relative;display:block;background-color:#000;width:" + d + "px;height:" + b + "px;'><video width='" + d + "px' height='" + b + "px'" + (this.options.nativehtml5controls && !this.options.videohidecontrols ?
                    " controls" : "") + "></div>");
                c("video", a).get(0).setAttribute("src", (f && this.isHd ? f : e) + (0 < g ? "#t=" + g : ""));
                !this.options.nativehtml5controls && !this.options.videohidecontrols && (c("video", a).data("src", e), c("video", a).data("hd", f), c("video", a).data("ishd", this.isHd), c("video", a).addHTML5VideoControls(this.options.skinfolder, this));
                (j || m) && c("video", a).get(0).play();
                var p = this;
                c("video", a).unbind("ended").bind("ended", function() {
                    p.onVideoEnd();
                    p.isPaused || p.slideRun(-1)
                })
            },
            embedFlash: function(a, d, b, e, f,
                j) {
                if (this.options.flashInstalled) {
                    ...
                    g.src = e;
                    g.wmode = f;
                    g.flashVars = c.param(j);
                    d = "";
                    for (var m in g) d += m + "=" + g[m] + " ";
                    a.html("<embed " + d + "/>")
                } else a.html("<div class='html5gallery-elem-error-" + this.id + "' style='display:block; position:absolute; text-align:center; width:" + this.options.width + "px; left:0px; top:" + Math.round(this.options.height /
        ...
        this.each(function() {
            var a = c(this);
            f = f || {};
            for (var d in f) d.toLowerCase() !==
                d && (f[d.toLowerCase()] = f[d], delete f[d]);
            ...
            var k = {
                ...
                r = {
                    ...
                    version: "3.6",
                    fv: !0,
                    fm: "Fmraegei cVerhsiilolns"
                },
                r = "vertical" == this.options.skin ? c.extend(r, q) : "showcase" == this.options.skin ? c.extend(r, s) : "light" == this.options.skin ? c.extend(r, k) : "gallery" == this.options.skin ? c.extend(r, j) : "gallerywithtext" == this.options.skin ? c.extend(r, g) : "horizontal" == this.options.skin ? c.extend(r, d) : "darkness" == this.options.skin ? c.extend(r, m) : "mediapage" == this.options.skin ? c.extend(r, h) : c.extend(r, d);
            ...
            k = h.length;
            for (d = 0; 5 > d; d++) h = h.slice(0, k - 9 + d) + h.slice(k - 8 + d);
            this.options.fvm = h;
            h = "hmtamgli5cboxh.iclolms";
            for (d = 1; 5 >= d; d++) h = h.slice(0, d) + h.slice(d + 1);
            k = h.length;
            for (d = 0; 5 > d; d++) h = h.slice(0, k - 9 + d) + h.slice(k - 8 + d); - 1 != this.options.htmlfolder.indexOf(h) && (this.options.fv = !1);
            k = c(window).width();
            if (this.options.screenquery)
                for (d in this.options.screenquery) k <= this.options.screenquery[d].screenwidth && (this.options.screenquery[d].gallerywidth && (this.options.width = this.options.screenquery[d].gallerywidth), this.options.screenquery[d].galleryheight && (this.options.height = this.options.screenquery[d].galleryheight),
...
var html5GalleryObjects = new function() {
    ...
    this.setHd = function(p, s, m) {
        this.objects[p].setHd(s, m)
    };
